...
public class HistoryActivity extends AppCompatActivity implements View.OnClickListener, ShowAdFilter {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.baisi.spedometer.R.layout.activity_history);
        initViewAndData();
        initRecycleView();
        showAd();
        Firebase.getInstance(getApplicationContext()).logEvent("HistoryActivity", "进入");
    }
...
//        recyclerView.setAdapter(historyAdapter);
    ...
    private void showAd() {
        /*加载广告*/
        GoogleAd.loadAd(frameLayout ,0 ,"historyactivity");
    }
    ...
    Observer<List<StepDataNormal>> observer = new Observer<List<StepDataNormal>>() {
        ...
        public void onNext(List<StepDataNormal> value) {
            ...
            recyclerView.setLayoutManager(linearLayoutManager);
            recyclerView.setAdapter(historyAdapter);
            //recyclerView.addItemDecoration(new SportDecoration(HistoryActivity.this  , DividerItemDecoration.VERTICAL));
