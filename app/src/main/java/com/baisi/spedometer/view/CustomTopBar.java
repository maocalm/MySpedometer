...
public class CustomTopBar extends RelativeLayout implements View.OnClickListener {
    ...
    public CustomTopBar(final Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        /**返回按钮相关*/
        left_button_imageId = typedArray.getResourceId(R.styleable.CustomTopBar_left_button_image, 0);
        left_button_text = typedArray.getString(R.styleable.CustomTopBar_left_button_text);
        left_button_textColor = typedArray.getColor(R.styleable.CustomTopBar_left_button_textColor, Color.GRAY);
        left_button_textSize = typedArray.getDimensionPixelSize(R.styleable.CustomTopBar_left_button_textSize, sp2px(context, 14));

        /**标题相关*/
        title_background_color = typedArray.getColor(R.styleable.CustomTopBar_title_background, getResources().getColor(R.color.main_activity_bg));
        title_text = typedArray.getString(R.styleable.CustomTopBar_title_text);
        title_textColor = typedArray.getColor(R.styleable.CustomTopBar_title_textColor, Color.GRAY);
        title_textSize = typedArray.getDimensionPixelSize(R.styleable.CustomTopBar_title_textSize, sp2px(context, 14));

        /**右边保存按钮相关*/
        right_button_image_id = typedArray.getResourceId(R.styleable.CustomTopBar_right_button_image,0);
        right_button_text = typedArray.getString(R.styleable.CustomTopBar_right_button_text);
        right_button_textColor = typedArray.getColor(R.styleable.CustomTopBar_right_button_textColor, Color.GRAY);
        right_button_textSize = typedArray.getDimensionPixelSize(R.styleable.CustomTopBar_right_button_textSize, sp2px(context, 14));

        /**分割线*/
        typedArray.getBoolean(R.styleable.CustomTopBar_show_line, true);
