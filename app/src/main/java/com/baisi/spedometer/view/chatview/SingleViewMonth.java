...
/**
 * Created by hanwenmao on 2018/1/2.
 */
...
public class SingleViewMonth extends View {
    ...
    private void initStart() {
        ...
        if (singViewType.equals("today")) {
            ...
            mChartWidth = densityUtil.dip2px(6);
            int number = StepConversion.getCurrentMonthDay();
            gapidth = ((getWidth() - mStartWidth) - lengthToRight - number * mChartWidth) / (number-1);
            indexTextRectWidth = (getWidth() - mStartWidth - lengthToRight) / 5;
        }
        ...
        for (int i = 0; i < n; i++) {
            ...
            switch (attr) {
                ...
                case R.styleable.MyChartView_selectLeftColor:
                    ...
                    break;
                case R.styleable.MyChartView_typeKind:
                    singViewType = array.getString(attr);
                    break;
                default:
                    bringToFront();
            }
    ...
    protected void onWindowVisibilityChanged(int visibility) {
        ...
        if (singViewType.equals("week")){
            ...
            String  month  = StepConversion.getMonth(new Date()) ;
            int j = 3 ;
            for (int i = 0; i <5 ; i++) {
                list_bottom.add(month+j);
                j+=6;
            }
        }
