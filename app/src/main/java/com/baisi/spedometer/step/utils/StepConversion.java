...
public class StepConversion {
    ...
    public static void initConversion() {
        SharedPreferencesUtils mSpUtils = new SharedPreferencesUtils(PedometerApplication.getApplicationContextPedometer());
     ...
     * @return Kcal
     */
    public static String getCalorie(int mStep) {
        initConversion();
        Float value = (weight / 2000) * mStep;
    ...
    public static String getDistance(int mStep) {
        ...
        if (gender != null) {
            ...
            value = mStep * sexParameter * height / 100000;
    ...
    public static Float getDistanceFloat(int mStep) {
     ...
     * @return
     */
    public static ArrayList getCalorieList(List<Float> stepList) {
        initConversion();
    ...
    public static ArrayList getTimeList() {
        initConversion();
        //模拟数据 ；
        ArrayList arrayList = new ArrayList();
        arrayList.add(1f);
    ...
    public static ArrayList getDistanceList(List<Float> stepList) {
        initConversion();
        ArrayList arrayList = new ArrayList();
        float sexParameter, value = 0;
...
//        index = calendar.get(Calendar.HOUR_OF_DAY);
     ...
     * @return
     */
    public static String getSimpleDateYYMM(Date date) {
        //Date date = new Date(System.currentTimeMillis());
...
// 获取当天23点59分59秒Date
     ...
     * @return
     */
    public static Date getTimes1Monthmorning(Date date, int month) {  // 0  代表一月份；
        Calendar cal = Calendar.getInstance();
        cal.setTime(date);
        cal.set(cal.get(Calendar.YEAR), month, 0, 0, 0, 0);
        cal.set(Calendar.DAY_OF_MONTH, cal.getActualMinimum(Calendar.DAY_OF_MONTH));
        return cal.getTime();
    }
